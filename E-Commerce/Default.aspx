<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="Default.aspx.cs" Inherits="E_Commerce._Default" %>
                        ...
                        <div class="card border border-dark bg-info text-white">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between w-100">
                                    <a href='<%# "Dettaglio.aspx?idArticle=" + Eval("Id") %>' class="btn btn-sm btn-success">Dettagli</a>
